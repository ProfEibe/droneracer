 ...
 */
UCLASS()
class DRONERACER_API UHUDBlueprintLibrary : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()
public:
	/**
	...
	* @param		PlayerID	- The PlayerID which Pawn will calculated relativly
	...
	*/
	UFUNCTION(BlueprintPure, meta = (WorldContext = "WorldContextObject", CallableWithoutWorldContext), Category = "HUD|Util")
		static void FindScreenEdgeLocationForWorldLocation(UObject* WorldContextObject, const FVector& InLocation, const FVector2D& InViewportSize, const FVector2D& InOffset, const int PlayerID, const float EdgePercent, FVector2D& OutScreenPosition, float& OutDistance, float& OutRotationAngleDegrees, bool &bIsOnScreen);
